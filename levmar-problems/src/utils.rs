...
use nalgebra::{
    ...
    allocator::Allocator, storage::RawStorage, storage::Storage,
};
...
pub fn dot<F, N, AS, BS>(a: &Vector<F, N, AS>, b: &Vector<F, N, BS>) -> F
where
...
pub fn float_repr<F: Float>(f: F) -> String {
...
#[test]
fn test_linear_case() {
    use crate::problems::LinearFullRank;
    use approx::assert_relative_eq;
